...
import { Bell, User, Languages, Scale, LogOut } from "lucide-react";
  ...
  return (
    <div className="max-w-2xl mx-auto px-5 py-5 pb-32 space-y-4">
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        {/* LANGUAGE */}
        <button onClick={setLanguage} className="bg-card border border-border rounded-2xl p-4 h-[125px] text-left">
          <Languages className="w-7 h-7 text-orange-500 mb-3" />
