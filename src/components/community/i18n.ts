...
export const dict = {
  en: {
    inviteByEmail: "Invite by email", inviteHint: "Use this if the person is not listed yet.", fullName: "Full name", emailLabel: "Email address", sendInvite: "Send invitation", pendingInvites: "Pending invitations", pendingInvitation: "Pending invitation", inviteSent: "Invitation saved. They will join this group when they sign up.", memberAdded: "Member added to the group", addMember: "Add member", alreadyMemberMsg: "That person is already in this group", invalidEmail: "Enter a valid email address", invalidPhone: "Enter a valid phone number", cancelInvite: "Cancel invitation", availablePeople: "Approved people not in this group", selectedCount: "selected", inviteByEmailOrPhone: "Invite by email or phone", phoneLabel: "Phone number", phoneInviteHint: "If this number belongs to an eligible discoverable Prayer & Fire account, they will be added directly.", phoneInviteRequired: "A phone number cannot join a group by itself. They must have or create a Prayer & Fire account and accept the secure invitation.", noEligibleMember: "No eligible member found", inviteByText: "Invite by text message", smsInviteText: "You're invited to join a Prayer & Fire group. Create or sign in to your account, then accept this invitation:", smsUnavailable: "Could not open text messages. Use the share sheet to send the invitation.", tooManyLookups: "Too many lookups. Try again later.",
