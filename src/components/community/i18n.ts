...
export const dict = {
  en: {
    inviteByEmail: "Invite by email", inviteHint: "Use this if the person is not listed yet.", fullName: "Full name", emailLabel: "Email address", sendInvite: "Send invitation", pendingInvites: "Pending invitations", pendingInvitation: "Pending invitation", inviteSent: "Invitation saved. They will join this group when they sign up.", memberAdded: "Member added to the group", alreadyMemberMsg: "That person is already in this group", invalidEmail: "Enter a valid email address", cancelInvite: "Cancel invitation", availablePeople: "Approved people not in this group", selectedCount: "selected", inviteByEmailOrPhone: "Invite by email or phone", phoneLabel: "Phone number", phoneInviteHint: "Pick the country code and type the number. This can only add someone who already has a Prayer & Fire account, saved this number and turned on 'Allow people to find me by phone number'.", noEligibleMember: "No eligible member found", tooManyLookups: "Too many lookups. Try again later.",
