...
export const dict = {
  en: {
    ...
    actionFailed: "Something went wrong. Please try again.", savedDone: "Saved", archivedDone: "Chat archived", unarchivedDone: "Chat restored", photoUpdated: "Group photo updated", groupDeleted: "Group deleted", leftGroup: "You left the group",
    ownerCannotLeave: "You created this group, so you cannot leave it. Make someone else the owner first, or delete the group.",
    leaveGroupBody: "You will stop receiving messages from this group. A leader will have to add you back.",
    archiveGroup: "Archive chat", unarchiveGroup: "Restore chat", archivedChats: "Archived chats", backToChats: "Back to chats", noArchived: "No archived chats",
    ...
    onlyAdminsCreate: "Only leaders can create groups", loading: "Loading conversations…", loadError: "We could not load your conversations.", retry: "Try again", back: "Back", noPermission: "You do not have permission",
  ...
  es: {
    ...
    actionFailed: "Algo salió mal. Inténtalo de nuevo.", savedDone: "Guardado", archivedDone: "Chat archivado", unarchivedDone: "Chat restaurado", photoUpdated: "Foto del grupo actualizada", groupDeleted: "Grupo eliminado", leftGroup: "Saliste del grupo",
    ownerCannotLeave: "Creaste este grupo, así que no puedes salir. Primero haz propietario a otra persona o elimina el grupo.",
    leaveGroupBody: "Dejarás de recibir los mensajes de este grupo. Un líder tendrá que volver a agregarte.",
    archiveGroup: "Archivar chat", unarchiveGroup: "Restaurar chat", archivedChats: "Chats archivados", backToChats: "Volver a los chats", noArchived: "No hay chats archivados",
    ...
    onlyAdminsCreate: "Solo los líderes pueden crear grupos", loading: "Cargando conversaciones…", loadError: "No pudimos cargar tus conversaciones.", retry: "Reintentar", back: "Atrás", noPermission: "No tienes permiso",
  ...
  pt: {
    ...
    actionFailed: "Algo deu errado. Tente novamente.", savedDone: "Salvo", archivedDone: "Conversa arquivada", unarchivedDone: "Conversa restaurada", photoUpdated: "Foto do grupo atualizada", groupDeleted: "Grupo excluído", leftGroup: "Você saiu do grupo",
    ownerCannotLeave: "Você criou este grupo, então não pode sair. Torne outra pessoa proprietária primeiro ou exclua o grupo.",
    leaveGroupBody: "Você deixará de receber as mensagens deste grupo. Um líder terá que adicionar você novamente.",
    archiveGroup: "Arquivar conversa", unarchiveGroup: "Restaurar conversa", archivedChats: "Conversas arquivadas", backToChats: "Voltar às conversas", noArchived: "Nenhuma conversa arquivada",
    ...
    onlyAdminsCreate: "Somente líderes podem criar grupos", loading: "Carregando conversas…", loadError: "Não foi possível carregar suas conversas.", retry: "Tentar novamente", back: "Voltar", noPermission: "Você não tem permissão",
