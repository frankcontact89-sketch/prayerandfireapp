...
export function HomeScreen({ t }: HomeScreenProps) {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-black text-white">
      ...
      <div className="absolute bottom-[-120px] right-[-100px] w-[300px] h-[300px] bg-orange-500/10 blur-[120px] pointer-events-none" />
      ...
      <div className="relative z-10 px-6 pt-8 pb-28">
        ...
        {/* Planet glow */}
        <div className="relative h-[55px] mb-[-10px] pointer-events-none">
